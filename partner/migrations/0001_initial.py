# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-12-09 11:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('manufacturer', 'Manufacturer'), ('distributor', 'Distributor'), ('retailer', 'Retailer'), ('employee', 'Employee')], max_length=255)),
                ...
                ('buys_from', models.ManyToManyField(related_name='_partner_buys_from_+', to='partner.Partner')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='partner.Product'),
        ),
        migrations.AddField(
            model_name='partner',
            name='sells_to',
            field=models.ManyToManyField(related_name='_partner_sells_to_+', to='partner.Partner'),
        ),
        migrations.AddField(
            model_name='partner',
            name='user',
